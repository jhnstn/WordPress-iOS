...
def gutenberg(options)
    options[:git] = 'https://github.com/jhnstn/mockenberg-mobile.git'
...
def gutenberg_dependencies(options)
    ...
    if options[:path]
        ...
        podspec_prefix = "https://raw.githubusercontent.com/jhnstn/mockenberg-mobile/#{tag_or_commit}"
    end
...
abstract_target 'Apps' do
    ...
    ## =====================
    ##
    gutenberg :commit => '2c5191c65fbbda83d0a1c3a78a1a8da82e13b040'
